...
export default function Card({ item, onDragStart }: CardProps) {
  return (
    <div
      draggable
      onDragStart={onDragStart}
      className={`bg-white/[0.08] rounded-lg p-3 cursor-grab active:cursor-grabbing hover:bg-white/[0.12] hover:translate-x-1 transition-all border-l-4 ${typeColors[item.type]}`}
    >
